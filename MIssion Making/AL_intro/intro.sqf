...
_txt1 = ["South Vietnam - 1967",20,"center_bottom","1","#FFFFFF"] execVM "AL_intro\txt_display.sqf";
_firstshot = [cam0, cam1, target1, 20, 0.5, 0.5,false,4, -3, 0,TRUE] execVM "AL_intro\camera_work.sqf";
